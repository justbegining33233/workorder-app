// Enhanced Navigation Component for Super Admin Role
// Focuses on enterprise-level management, multi-tenant oversight, and system-wide control
...
export default function SuperAdminNavigation({
  ...
  useEffect(() => {
    setNotifications(systemAlerts + tenantIssues + securityIncidents + deploymentTasks);
  }, [systemAlerts, tenantIssues, securityIncidents, deploymentTasks]);
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      icon: FaBuilding,
      badge: tenantIssues > 0 ? tenantIssues : undefined,
