    ...
    <div style={{minHeight:'100vh', background:'linear-gradient(135deg, #3d3d3d 0%, #4a4a4a 50%, #525252 100%)'}}>
      ...
      <div style={{maxWidth:1200, margin:'0 auto', padding:32}}>
        <div style={{background:'rgba(0,0,0,0.3)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:12, padding:32, textAlign:'center'}}>
          ...
          <h2 style={{fontSize:24, fontWeight:700, color:'#e5e7eb', marginBottom:16}}>Time Tracking System</h2>
          <p style={{fontSize:16, color:'#9aa3b2'}}>Clock in/out functionality and timesheet management coming soon.</p>
        </div>
      </div>
    </div>
  );
