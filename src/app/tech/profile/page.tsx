...
import { FaUser, FaEnvelope, FaPhone, FaTools, FaSave, FaCog, FaClock } from 'react-icons/fa';
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-500">Manage your technician account</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-medium text-gray-900">{name || 'Technician'}</p>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">Contact your shop manager to change email</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href={'/tech/timeclock' as Route} className="flex items-center gap-2 text-blue-600 hover:text-blue-800 text-sm">
            <FaClock className="w-4 h-4" /> Time Clock
          </Link>
          <Link href={'/tech/settings/two-factor' as Route} className="flex items-center gap-2 text-blue-600 hover:text-blue-800 text-sm">
