  ...
  return (
    <div style={{ minHeight: '100vh', background: '#09090B', color: '#e2e8f0' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '24px 20px' }}>
        <Link href={'/tech/home' as Route} style={{ color: '#93c5fd', textDecoration: 'none', fontSize: 14 }}>
          Back to Tech Home
        </Link>
              ...
              {section === 'contact' && (
                <div style={{ background: '#0b1220', border: '1px solid #1e293b', borderRadius: 12, padding: 16 }}>
                  ...
                  <div style={{ display: 'grid', gap: 10, maxWidth: 620 }}>
                    ...
                    <button onClick={handleSave} disabled={saving} style={{ width: 'fit-content', padding: '10px 14px', borderRadius: 8, border: 'none', background: '#0284c7', color: 'white', fontWeight: 700, cursor: 'pointer', opacity: saving ? 0.75 : 1 }}>
