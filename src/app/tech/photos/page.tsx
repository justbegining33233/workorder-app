    ...
    <div style={{minHeight:'100vh', background:'linear-gradient(135deg, #3d3d3d 0%, #4a4a4a 50%, #525252 100%)'}}>
      <div style={{background:'rgba(0,0,0,0.3)', borderBottom:'1px solid rgba(245,158,11,0.3)', padding:'20px 32px'}}>
        <div style={{maxWidth:1200, margin:'0 auto'}}>
          ...
          <h1 style={{fontSize:28, fontWeight:700, color:'#e5e7eb', marginBottom:8}}>📸 Photo Upload</h1>
          <p style={{fontSize:14, color:'#9aa3b2'}}>Upload and manage photos for work orders and documentation</p>
        </div>
      </div>
      ...
      <div style={{maxWidth:1200, margin:'0 auto', padding:32}}>
        <div style={{background:'rgba(0,0,0,0.3)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:12, padding:32, textAlign:'center'}}>
          ...
          <h2 style={{fontSize:24, fontWeight:700, color:'#e5e7eb', marginBottom:16}}>Photo Documentation</h2>
          <p style={{fontSize:16, color:'#9aa3b2', marginBottom:24}}>Photo upload and gallery management coming soon.</p>
