...
import { FaUser, FaEnvelope, FaPhone, FaShieldAlt, FaSave, FaCog } from 'react-icons/fa';
    ...
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-medium text-gray-900">{name || 'Administrator'}</p>
        ...
        <div className="flex items-center gap-3 pt-2">
          <button onClick={handleSave} disabled={saving}
            className="flex items-center gap-2 bg-orange-600 text-white px-6 py-2 rounded-lg hover:bg-orange-700 disabled:opacity-50">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href={'/admin/settings' as Route} className="flex items-center gap-2 text-orange-600 hover:text-orange-800 text-sm">
