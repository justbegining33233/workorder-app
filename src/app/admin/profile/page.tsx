                ...
                <div style={{ background: '#0b1220', border: '1px solid #1e293b', borderRadius: 12, padding: 16 }}>
                  ...
                  <div style={{ display: 'grid', gap: 10, maxWidth: 620 }}>
                    ...
                    <button
                      onClick={handleSave}
                      disabled={saving}
                      style={{ width: 'fit-content', padding: '10px 14px', borderRadius: 8, border: 'none', background: '#2563eb', color: 'white', fontWeight: 700, cursor: 'pointer', opacity: saving ? 0.75 : 1 }}
                    >
              ...
              {section === 'links' && (
                <div style={{ background: '#0b1220', border: '1px solid #1e293b', borderRadius: 12, padding: 16 }}>
                  ...
                  <div style={{ display: 'grid', gap: 10, maxWidth: 440 }}>
                    <Link href={'/admin/settings' as Route} style={{ textDecoration: 'none', color: '#bfdbfe', border: '1px solid #1e3a8a', borderRadius: 8, padding: '10px 12px', background: 'rgba(30,64,175,0.15)' }}>
                      Settings
                    </Link>
                    <Link href={'/admin/home' as Route} style={{ textDecoration: 'none', color: '#bfdbfe', border: '1px solid #1e3a8a', borderRadius: 8, padding: '10px 12px', background: 'rgba(30,64,175,0.15)' }}>
                      Admin Dashboard
                    </Link>
                  </div>
                </div>
